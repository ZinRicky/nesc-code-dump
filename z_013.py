...
names = pd.read_csv("polished_data/people_nodes.csv").Name.tolist()
...
df.sort_values(by="Tradwife PageRank", ascending=False).to_csv(
    os.path.join("polished_data", "people_local_page_rank.csv"),
    index=False,
    quoting=csv.QUOTE_NONNUMERIC,
)

df.to_excel(os.path.join("polished_data", "people_local_pagerank.xlsx"), index=False)
